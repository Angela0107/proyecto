                    ...
                    <div class="form-row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nom_ben" name="nom_ben"
                               ...
                               onkeyup="this.value = this.value.toUpperCase(); actualizarContadorNom(this)">
                        <small id="contadorNom" class="form-text text-muted">0 / 60 caracteres</small>
                        </div>

            <script>
                        function actualizarContadorNom(input) {
    const contador = document.getElementById('contadorNom');
...
document.addEventListener('DOMContentLoaded', () => {
    const dirInput = document.getElementById('nom_ben');
    if (dirInput) actualizarContadorNom(dirInput);
});
                    </script>
