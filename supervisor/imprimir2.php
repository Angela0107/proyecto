...
$punto_medio = ceil($num_registros / 2) * 10;
...
$monto_formateado = number_format($monto, 2, ',', '.');
 ...
 WHERE s.idsolicitud IN ($solicitudes_string) GROUP BY s.idsolicitud;";
  ...
  $maxRowsPerTable = [$punto_medio, $punto_medio, 300]; // Alturas de los contenedores
...
<head>
  ...
  <style>
    ...
    table {
      ...
      /* Para que las celdas se vean unidas */
      font-size: x-small;
    }
      ...
      <div class="borderedcuenta bordered">
        ...
        <strong>
          <div class="" style="display: flex;">
            ...
            <div style="margin-left: 45px;">Pag 1/ 2</div>
          </div>
      </div>
    </div>
    </strong>
    ...
    <div class="form-row1">
      ...
      <div class="borderedcuenta bordered">
        <strong>
          ...
          <div class="" style="display: flex;">
            <div style="margin-left: 110px;"><?php echo $nropto ?></div>
            <div style="margin-left: 45px;">Pag 2/ 2</div>
          </div>
      </div>
    </div>
    </strong>
    ...
    <form method="POST">
      ...
      <div class="form-row">
        <div class="borderedargumento2 bordered">
          <div class="texto_argumento" style="margin-top: 10px;">
            <?php echo $tabla20 ?>
          </div>
        </div>
      </div>
